<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Detailofblogger.aspx.cs" Inherits="postdetail" %>
  ...
  <div>
    <ul>
      <li>
        ...
        <ul>
          <li><a href="index-2.html">Home - All Block</a></li>
          <li>
      ...
      <li>
        ...
        <ul>
          <li>
            <a href="index-2.html">Header Style</a>
            <ul>
          ...
          <li>
            <a href="index-2.html">Footer Style</a>
            <ul>
              <li><a href="index-2.html#footer">Footer Style 1</a></li>
