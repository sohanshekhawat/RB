<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BlogCategory.aspx.cs" Inherits="Admin_BlogCategory" %>
                                        ...
                                        <table cellpadding="10" align="center" style="font-weight: 500">
                                            ...
                                            <tr>
                                                <td colspan="2" align="center">
                                                    <asp:Button ID="btadd" runat="server" Text="Save" class="btn btn-info" 
                                                        Width="100px" onclick="btadd_Click" 
                                                       />
                                                                        ...
                                                                        <tr>
                                                                            <td style="width: 35px;">
                                                                                <asp:CheckBox ID="chkbody" runat="server" />
                                                                                 <asp:Label ID="lbluid" runat="server" Text='<%# Eval("Category_id") %>' Visible="False"></asp:Label>
                                                                            </td>
                                                                            
                                                                                <td style="width: 100">
                                                                                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("Category_Nm") %>'></asp:Label>
                                                                                </td>
                                                                              
                                                                                <td style="padding-top: 5px; padding-bottom: 5px;">
                                                                                    <asp:LinkButton ID="btnedit" CssClass="btn btn-primary" runat="server" CausesValidation="False"
                                                                                        CommandName="btnedit" CommandArgument='<%# Eval("Category_id") %>' >
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:LinkButton ID="lbdelete" CausesValidation="false" runat="server" 
                                                        class="btn btn-danger" onclick="lbdelete_Click"
                                                        ><span class="glyphicon glyphicon-trash"></span> Delete</asp:LinkButton>
                                                </td>
                                                <td align="right">
                                                    &nbsp;
