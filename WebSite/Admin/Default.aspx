...
<head>
    ...
    <script type='text/javascript'>
        ...
        function showdialog(id, type) {
            ...
            document.getElementById('rbtnpending').checked = true;
                            ...
                            <div class="widget-body form">
                                <div class="control-group">
                                    <table class="style1" style="width:100%">
                                        <tr>
                                            <td style="text-align: center; font-size: 20px; font-weight: bold" height="30px">
                                                Organization
                                            </td>
                                            <td style="text-align: center; font-size: 20px; font-weight: bold" height="30px">
                                                Blogger
                                        ...
                                        <tr>
                                            <td style="text-align: center;" width="33%">
                                                <div style="border-radius: 100% 100% 100% 100%; -moz-border-radius: 100% 100% 100% 100%;
                                                    -webkit-border-radius: 100% 100% 100% 100%; border: 3px solid #A6CE39; height: 150px;
                                                    ...
                                                    <div style="background-color: White; padding: 43%; border-radius: 100% 100% 100% 100%;
                                                        ...
                                                        font-size: 32px;">
                                                        <asp:Label ID="lblor" runat="server" Text="Label"></asp:Label>
                                                    </div>
                                                </div>
                                            </td>
                                            <td width="33%" style="text-align: center;">
                                                <div style="border-radius: 100% 100% 100% 100%; -moz-border-radius: 100% 100% 100% 100%;
                                                    ...
                                                    <div style="background-color: White; padding: 43%; border-radius: 100% 100% 100% 100%;
                                                        -moz-border-radius: 100% 100% 100% 100%; -webkit-border-radius: 100% 100% 100% 100%;
                                                        font-size: 32px;">
                                                        <asp:Label ID="lblb" runat="server" Text="Label"></asp:Label></div>
                                                </div>
                                            </td>
                                            <td width="33%" style="text-align: center;">
                                                <div style="border-radius: 100% 100% 100% 100%; -moz-border-radius: 100% 100% 100% 100%;
                                                ...
                                                <div class="widget" style="width: 90%;">
                                                    <div class="widget-title">
                                                        <h4 style="text-align: center; font-size: 20px; font-weight: bold">
                                                            List Of Pending Organizations</h4>
                                                        &nbsp;</div>
                                                    <div class="widget-body form">
                                                        <div class="control-group">
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <table style="width: 100%; table-layout: fixed; text-align: center;">
                                                                                            <tr>
                                                                                                ...
                                                                                                <td style="width: 100">
                                                                                                    <asp:LinkButton ID="btnprofile" runat="server" CausesValidation="False" CommandName="btnprofile"
                                                                                                        Text='<%# Eval("Name") %>' CommandArgument='<%# Eval("Organization_id") %>' OnClick="btnprofile_Click">Update</asp:LinkButton>
                                                                                                </td>
                                                                                                <td style="padding-top: 5px; padding-bottom: 5px; width: 100">
                                                                                                    ...
                                                                                                    <br />
                                                                                                    <a id="btnsend" class="btn btn-gray" style="width: 50px;" onclick="showdialog(<%# Eval("Organization_id") %>,'O');" class="js-open-modal" data-modal-id="popup">
                                                                                                        &nbsp;Change Status&nbsp; </a>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                               ...
                               <asp:ImageButton ID="btnCancel" runat="server" ImageUrl="~/Admin/img/close.png" CausesValidation="False" class="js-modal-close btnclose"/>
                                        <div class="widget-title" style="padding-left: 5px; padding-top: 5px; text-align: center">
                                             Reject/Approve Organization Or Blogger</div>
                                        <div class="widget-body form">
