<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrganizationsList.aspx.cs"
    Inherits="Admin_OrganizationsList" %>
                    ...
                    <div class="span12">
                        ...
                        <div class="widget" id="viewtable" visible="false" runat="server">
                            <div class="widget-title">
                                <h4>
                                    Organization List</h4>
                                <asp:Label ID="lblid" runat="server" Visible="False">0</asp:Label>
                                &nbsp;<asp:Label ID="lblfilename" Visible="false" runat="server"></asp:Label><span
                                    style="color: Gray; font-size: 12px">(* fields are mandatory)</span>
                                <div style="width: 15px; float: right; padding-right: 20px">
                            ...
                            <div class="widget-body form">
                                <div class="control-group">
                                    <table cellpadding="10" align="center" style="font-weight: 500">
                                        <tr>
                                            <td rowspan="17" align="right" valign="top">
                                                <br />
                                            </td>
                                            <td colspan="2">
                                                ...
                                                <br />
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <asp:Label ID="lblimgmsg" runat="server" Text="Maximum File Size 10 Mb"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtName"
                                                    ForeColor="Red" ValidationGroup="ol" SetFocusOnError="True">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtAddress" runat="server" Width="360px" TextMode="MultiLine"></asp:TextBox><asp:RequiredFieldValidator
                                                    ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtAddress" ForeColor="Red"
                                                    ValidationGroup="ol" SetFocusOnError="True">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Enter valid Zipcode"
                                                    ...
                                                    ValidationGroup="ol" Display="Dynamic"></asp:RegularExpressionValidator>
                                                &nbsp;&nbsp; Country&nbsp;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Invalid Email"
                                                    ...
                                                    ForeColor="Red" ValidationGroup="ol" SetFocusOnError="True"></asp:RegularExpressionValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="Should be 0 to 9 Digits"
                                                    ...
                                                    ValidationGroup="ol" Display="Dynamic" SetFocusOnError="True"></asp:RegularExpressionValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="Enter 6 To 10 Digits "
                                                    ...
                                                    ValidationGroup="ol"></asp:RegularExpressionValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                ...
                                                <div id="transliterate">
                                                    ...
                                                    <p>
                                                        ...
                                                        <textarea id="transl2" style="background: rgb(238, 238, 238) none repeat scroll 0% 0%;
                                                            ...
                                                            font-family: Arial,Helvetica,sans-serif; font-size: 14px;" runat="server"></textarea></p>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" align="center">
                                                <asp:Button ID="btadd" runat="server" Text="Add" class="btn btn-info" Width="100px"
                                                    OnClick="btadd_Click" ValidationGroup="ol" />
                        ...
                        <div class="widget">
                            <div class="widget-title">
                                ...
                                <div style="float: right; padding-right: 30px; margin-top: 5px;">
                                    <asp:Button ID="btnadd" runat="server" CssClass="btn btn-success" Text="Add Organization"
                            ...
                            <div class="widget-body form">
                                <div class="form-group">
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <asp:GridView ID="gridbod" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                                                        AllowSorting="True" PageSize="10" Width="100%" OnPageIndexChanging="gridbod_PageIndexChanging"
                                                                    ...
                                                                    <table style="width: 100%; table-layout: fixed; text-align: center;">
                                                                        <tr>
                                                                            <td style="width: 35px;">
                                                                                ...
                                                                                <asp:Label ID="lbluid" runat="server" Text='<%# Eval("Organization_id") %>' Visible="False"></asp:Label>
                                                                            </td>
                                                                            <td style="width: 100px">
                                                                                <asp:Image ID="Image1" runat="server" ImageUrl='<%# Eval("ProfilePict","~/siteimages/OrganizationImg/{0}") %>'
                                                                            ...
                                                                            <td style="width: 100">
                                                                                <asp:LinkButton ID="btnprofileblog" runat="server" CausesValidation="False" CommandName="btnprofileblog"
                                                                                    Text='<%# Eval("Name") %>' CommandArgument='<%# Eval("Organization_id") %>' OnClick="btnprofileblog_Click"></asp:LinkButton>
                                                                            </td>
                                                                            <td style="width: 100">
                                                                            ...
                                                                            <td style="padding-top: 5px; padding-bottom: 5px; width: 100">
                                                                                ...
                                                                                <br />
                                                                                <a id="btnsend" class="btn btn-gray" style="width: 50px;" onclick="showdialog(<%# Eval("Organization_id") %>,'O');"
                                                                            ...
                                                                            <td style="padding-top: 5px; padding-bottom: 5px;">
                                                                                <asp:LinkButton ID="btnedit" CssClass="btn btn-primary" runat="server" CausesValidation="False"
                                                                                    CommandName="btnedit" CommandArgument='<%# Eval("Organization_id") %>'>
                                                                            Edit</asp:LinkButton>
                                                                            </td>
                                                                            <td style="padding-top: 5px; padding-bottom: 5px;">
                                                                                <asp:LinkButton ID="LinkButton1" runat="server" CommandName="btndelete" CausesValidation="False"
                                                                                    CssClass="btn btn-danger" CommandArgument='<%# Eval("Organization_id") %>'>
                                    ...
                                    <div id="popup" class="modal-box">
                                           <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Admin/img/close.png" CausesValidation="False" class="js-modal-close btnclose"/>
                                        <div class="widget-title" style="padding-left: 5px; padding-top: 5px; text-align: center">
                                            Reject/Approve Organization</div>
                                        <div class="widget-body form">
