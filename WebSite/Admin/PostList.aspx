                                ...
                                <div class="control-group">
                                    <table cellpadding="10" align="center" style="font-weight: 500">
                                        ...
                                        <tr>
                                            ...
                                            <ContentTemplate>
                                                <asp:DropDownList ID="dporga" runat="server" AutoPostBack="True" OnSelectedIndexChanged="dporga_SelectedIndexChanged"
                                                    ValidationGroup="pv">
                                                </asp:DropDownList>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="dporga"
                                                    Display="Dynamic" ErrorMessage="*" ForeColor="Red" InitialValue="0" ValidationGroup="pv" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                          </ContentTemplate>
                                          </asp:UpdatePanel>
                                            </td>
                                                                ...
                                                                <ItemTemplate>
                                                                    <table style="width: 100%; table-layout: fixed; text-align: center;">
                                                                        <tr>
                                                                            ...
                                                                            <td style="padding-top: 5px; padding-bottom: 5px;width:40px">
