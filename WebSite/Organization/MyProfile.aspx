<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyProfile.aspx.cs" Inherits="Organization_MyProfile" %>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <asp:GridView ID="gridbod" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                                                        AllowSorting="True" PageSize="8" Width="100%" OnPageIndexChanging="gridbod_PageIndexChanging"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 150px">
                                                                                <asp:Image ID="Image1" runat="server" ImageUrl='<%# Eval("ProfilePict", "~/siteimages/OrganizationImg/{0}") %>'
                                                                                    Height="120" Width="120" style=" border-radius: 75px;" />
                                                                            </td>
                                                                            ...
                                                                            <td style="padding-top: 5px; padding-bottom: 5px;width:75px">
                                                                                <asp:LinkButton ID="btnview" CssClass="btn btn-primary" runat="server" CausesValidation="False"
                                                                                    CommandName="btnview"  CommandArgument='<%# Eval("Organization_id") %>'>
                                                                            <span class="glyphicon glyphicon-pencil"></span>&nbsp;View</asp:LinkButton>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </ItemTemplate>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="cropped_">
                                                             ...
                                                             <a class="js-modal-close btnpropic">
                                           Set As Profile Picture</a>
