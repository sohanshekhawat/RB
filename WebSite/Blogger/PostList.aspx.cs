...
public partial class Admin_PostList : System.Web.UI.Page
{
    ...
    protected void btadd_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            int bloggerid = 0;
            int.TryParse(Application["blogid"].ToString(), out bloggerid);
            tbobj.Blogger_id = bloggerid;
    ...
    public void filldata()
    {
        try
        {
            ...
            var res = dbobj.tb_PostLists.Where(T => T.Blogger_id == id && T.Organization_id == id1).OrderByDescending(T => T.Post_id);
