                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body form">
                                                                ...
                                                                <ItemTemplate>
                                                                    <table style="width: 100%; table-layout: fixed; text-align: center;">
                                                                        <tr>
                                                                            ...
                                                                            <td style="padding-top: 5px; padding-bottom: 5px; width: 125px">
                                                                            ...
                                                                            <td style="padding-top: 5px; padding-bottom: 5px; width:75px">
                                                                                <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("Post_id") %>' CommandName="btndelete" CausesValidation="False"
                                ...
                                <div id="popup" class="modal-box">
                                  <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Blogger/img/close.png" CausesValidation="False" class="js-modal-close btnclose"/>
