...
<%@ Register Src="~/Blogger/UserControl/AdminScript.ascx" TagPrefix="uc" TagName="AdminScript" %>
<%@ Register Src="~/Blogger/UserControl/Admin_source.ascx" TagPrefix="uc" TagName="Admin_source" %>
<%@ Register Src="~/Blogger/UserControl/AdminSidebar.ascx" TagPrefix="uc" TagName="AdminSidebar" %>
<%@ Register Src="~/Blogger/UserControl/AdminHeader.ascx" TagPrefix="uc" TagName="AdminHeader" %>
                                ...
                                <div class="control-group">
                                    <table id="Table1" cellpadding="10" runat="server" align="center" style="font-weight: 500;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="cmbOrganization" runat="server" AutoPostBack="True" ValidationGroup="B">
                                                </asp:DropDownList>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="cmbOrganization"
                                                    ForeColor="Red" ValidationGroup="B" InitialValue="0" Display="Dynamic" SetFocusOnError="True">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="style1">
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="Enter 6 To 10 Digits "
                                                    ...
                                                    ValidationGroup="B" SetFocusOnError="True"></asp:RegularExpressionValidator>
                                        ...
                                        <tr>
                                            <td colspan="2" align="center">
                                                <asp:Button ID="btadd" runat="server" Text="Update" class="btn btn-info" Width="100px"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 150px">
                                                                                <asp:LinkButton ID="btnprofileblog" runat="server" CausesValidation="False" CommandName="btnprofileblog"
                                                                                    Text='<%# Eval("Name") %>' CommandArgument='<%# Eval("Blogger_id") %>'></asp:LinkButton>
                                                                            </td>
                                                                            <td style="width: 150px">
                                                                            ...
                                                                            <td style="padding-top: 5px; padding-bottom: 5px; width: 100px">
                                                                                <asp:LinkButton ID="btnview" CssClass="btn btn-primary" runat="server" CausesValidation="False"
                                                                                    CommandName="btnview" CommandArgument='<%# Eval("Blogger_id") %>'>
