                                ...
                                <div class="control-group">
                                    <table class="style1" style="width:100%">
                                        <tr style="width:100%;">
                                            ...
                                            <td style="font-size: 20px; font-weight: bold;padding-left:50%;width:100%" height="30px;">
                                                Post
                                            </td>
                                        ...
                                        <tr>
                                            <td width="100%" style="vertical-align: top;">
                                                <div class="widget" style="width: 100%;">
                                                    ...
                                                    <div class="widget-body form">
                                                        <div class="control-group">
                                                            <table cellpadding="10" style="font-weight: 500; width: 50%;text-align:left">
                                                                <tr>
                                                                    <td>
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                    ...
                                                                    <table style="width: 100%; table-layout: fixed; text-align:left;">
                                                                        <tr>
                                                                          <%--  <td style="width: 35px;">
                                                                            ...
                                                                            <td style="padding-top: 5px; padding-bottom: 5px; width: 25%">
                                                                ...
                                                                <HeaderTemplate>
                                                                    <table style="width: 100%; table-layout: fixed; text-align: left; height: 30px;">
                                                                        <tr>
                                                    ...
                                                    <table cellpadding="10" style="width: 100%; color: Black; margin: 5px">
                                                        <tr>
                                                            ...
                                                            <td width="50%" style="text-align: center">
                                                                ...
                                                                <asp:RadioButton ID="rbtnpending" runat="server" Enabled="False" ValidationGroup="rbstus"
                                                                    AutoPostBack="True" />
                                                                     Pending
                                                             
                                                                <asp:RadioButton ID="rbtnapprv" runat="server" AutoPostBack="True" Checked="True"
